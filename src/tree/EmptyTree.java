 ...
 */
 public class EmptyTree<K extends Comparable<K>,V> implements Tree<K,V> {
	...
	/*
	 * Tree<K,V> hasParent(K key,NonEmptyTree<K,V> parent,Tree<K,V> nextToFind){
	 * return this; }
	 */
	/*
	 * boolean isChild(Tree<K,V> tree){ return false; }
	 */
	...
	public void inorderTraversal(TraversalTask<K,V> p) {
		//nothing to do except stop the traversing
		return;
	}
